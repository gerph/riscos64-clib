...
/*
  ...
  Sourced from: https://gitlab.riscosopen.org/RiscOS/Sources/Lib/RISC_OSLib/-/blob/master/h/alloc
*/
...
/*
 * A variant of malloc that forces allocation to come from the RMA even if
 * the caller is in USR mode.
 */
